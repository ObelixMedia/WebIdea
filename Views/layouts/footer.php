...
<footer class="footer">
  ...
  <div class="span4">	<p style="margin-top: 15px;"><i class="icon-map-marker" style="font-size: 18px; color: white">  30 Bùi Thị Xuân, Tự An, Thành phố Buôn Ma Thuột, Đắk Lắk</i></p>
		<p style="margin-top: 15px;"><i class="icon-phone" style="font-size: 18px; color: white">  0964 55 44 99 (Ms Hiếu)</i></p>
		<p style="margin-top: 15px;"><i class="icon-phone" style="font-size: 18px; color: white">  098 5656 123 (Mr Nam)</i></p>
		<p style="margin-top: 15px;"><i class="icon-envelope" style="font-size: 18px; color: white">  inanytuongbmt@gmail.com</i></p></div>  
</div>
</div>
